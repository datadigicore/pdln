...
class SSP {
    ...
    static function filter ( $request, $columns, &$bindings )
    {
        ...
        for ( $i=0, $ien=count(isset($request['columns'])) ; $i<$ien ; $i++ ) {
            $requestColumn = isset($request['columns'][$i]);
            $columnIdx = array_search( $requestColumn['data'], $dtColumns );
            $column = $columns[ $columnIdx ];
    ...
    static function more_complex ( $request, $conn, $table1, $table2, $table3, $table4, $table5, $primaryKey, $columns, $whereResult=null, $whereAll=null ) {
        $bindings = array();
        $db = self::db( $conn );
        $localWhereResult = array();
        $localWhereAll = array();
    ...
    static function more_complex2 ( $request, $conn, $table1, $table2, $primaryKey, $columns, $whereResult=null, $whereAll=null ) {
        $bindings = array();
        $db = self::db( $conn );
        $localWhereResult = array();
        $localWhereAll = array();
