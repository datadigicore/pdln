                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                 <?php if ($data['cv_pemohon']!="") {?>
                                     <p class="form-control-static"><a href="<?php echo base_url(); ?>admin/download/<?php echo $data['cv_pemohon'] ?>" class="btn pdln-btn"><i class="fa  fa-download"></i> Unduh</a></p>
                                 <?php }else{
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <?php if ($data['karpeg_pemohon']!="") {?>
                                     <p class="form-control-static"><a href="<?php echo base_url(); ?>admin/download/<?php echo $data["karpeg_pemohon"] ?>" class="btn pdln-btn"><i class="fa  fa-download"></i> Unduh</a></p>
                                 <?php }else{
                                     /*echo '<script type="text/javascript">alert("'.$data["cv_pemohon"].'" );</script>';*/
                                     echo "<label>Tidak ada File</label>";
                                 } ?>                                    
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <?php if ($data['surat_unit_utama']!="") {?>
                                     <p class="form-control-static"><a href="<?php echo base_url();?>admin/download/<?php echo $data["surat_unit_utama"] ?>" class="btn pdln-btn"><i class="fa  fa-download"></i> Unduh</a></p>
                                 <?php }else{
                                     /*echo '<script type="text/javascript">alert("'.$data["cv_pemohon"].'" );</script>';*/
                                     echo "<label>Tidak ada File</label>";
                                 } ?> 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <?php if ($data['surat_undangan']!="") {?>
                                     <p class="form-control-static"><a href="<?php echo base_url();?>admin/download/<?php echo $data["surat_undangan"] ?>" class="btn pdln-btn"><i class="fa  fa-download"></i> Unduh</a></p>
                                 <?php }else{
                                     /*echo '<script type="text/javascript">alert("'.$data["cv_pemohon"].'" );</script>';*/
                                     echo "<label>Tidak ada File</label>";
                                 } ?>                             
