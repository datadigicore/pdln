  ...
  switch ($content) {
    ...
    case 'cetak_surat':
        ...
        if ($kondisi=="cari") {
          ...
          $result['query'] = $this->m_admin->list_admin_surat_cari($no_surat_bpkln_setneg,$id_admin);          
          $this->load->view('admin/cetak_surat', $result);
        } elseif ($kondisi=="cetak") {
          $result['query'] = $this->m_admin->list_admin_surat($id_admin);          
          $this->load->view('admin/cetak_surat', $result);
        }
    break;
    case 'excel':
  ...
  public function process(){
    ...
    case 'tab_pdln':
      ...
      array( 'db' => 'keterangan_sumber_dana_kegiatan',   'dt' => 10)
        ...
        $where = "instansi.id = data_diri.instansi_pemohon 
        AND sub_instansi.id_sub_instansi = data_diri.sub_instansi_pemohon AND 
        data_diri.no_aplikasi_data_diri = surat_unit_utama.no_aplikasi AND 
        data_diri.no_aplikasi_data_diri = surat_undangan.no_aplikasi";
    ...
    case 'tab_persetujuan_setneg':
      ...
      case 'edit_data_pdln':
        ...
        $id_admin = $_SESSION['logged']['id_user'];
        $table1='data_diri';
        $table2='surat_unit_utama';
        $table3='surat_undangan';
        $table4='surat_bpkln';
