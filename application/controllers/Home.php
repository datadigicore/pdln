  ...
  $this->load->view('template/footer');
    ...
    case 'tab_pdln':
      ...
      array( 'db' => 'keterangan_sumber_dana_kegiatan',   'dt' => 10)
        ...
        $where = "instansi.id = data_diri.instansi_pemohon AND sub_instansi.id_sub_instansi = data_diri.sub_instansi_pemohon AND data_diri.no_aplikasi_data_diri = surat_unit_utama.no_aplikasi AND data_diri.no_aplikasi_data_diri = surat_undangan.no_aplikasi AND data_diri.id_user='$id_user'";
    ...
    case 'tab_proses_pdln':
      ...
      AND surat_bpkln.no_surat_bpkln_setneg <> '' AND data_diri.id_user='$id_user'";
      $this->l_datatable->get_table_join_6($table1, $table2, $table3, $table4, $table5, $key, $column, $where);
      break;
    ...
    case 'tab_persetujuan_setneg':
      ...
      AND data_diri.status='Diterima' AND data_diri.id_user='$id_user'";
      $this->l_datatable->get_table_join_6($table1, $table2, $table3, $table4, $table5, $key, $column, $where);
      break;
