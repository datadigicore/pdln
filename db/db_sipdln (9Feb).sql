...
--
-- Host: localhost
-- Generation Time: Feb 09, 2016 at 11:50 PM
...
CREATE TABLE IF NOT EXISTS `surat_bpkln` (
  ...
  `tgl_surat_bpkln_kemlu` date DEFAULT NULL,
...
(87, 2, 4, 'bpklnsetneg/l.n/5', '2016-01-13', 'd9192c0c5a43c0301a95bcb3bdbfaed1.png', 'bpklnkemlu/l.n/5', '2016-01-13', '6ef6a8569891c63233ce0c43b1ae7ce6.png', 'setneg/l.n/5', '2016-01-27', '', 'disetujui 1 orang dari jumlah 1 orang'),
